                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          ...
                          return 'الاسم الأخير يجب أن يتكون من 3 أحرف على الأقل';
                        }
                        return null;
                      },
                      keyboardType: TextInputType.name,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const Text("مكونة من 8 أحرف على الأقل"),
                                  ],
                                ),
                                Row(
                                  children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    const Text("تحتوي على رقم واحد على الأقل"),
                                  ],
                                ),
                                Row(
                                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        hintText: "05********",
                        // Updated placeholder for phone number
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      List<AppUser?>? usersWithPhoneNumber =
                          await AppUserRepo().readAllWhere(
                        [
                      ...
                      if (usersWithPhoneNumber != null &&
                          usersWithPhoneNumber.isNotEmpty) {
                        SnackbarHelper.showError(context,
                            title: "يوجد حساب بالفعل بنفس الرقم!");
                        return;
                      }
